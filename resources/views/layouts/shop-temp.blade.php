...
<head>
    ...
    <link href="{{asset('')}}shop_assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('')}}shop_assets/css/bootstrap.extension.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('')}}shop_assets/css/style.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('')}}shop_assets/css/swiper.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('')}}shop_assets/css/sumoselect.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('')}}shop_assets/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    @yield('header')

    <link rel="shortcut icon" href="{{asset('')}}shop_assets/img/favicon.ico" />
    <title>EX ZO</title>
</head>
<body class="fonts-1">
                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-md-5 hidden-xs hidden-sm">
                            <div class="entry"><b>contact us:</b> <a href="tel:+84961330897">+84961330897</a></div>
                            <div class="entry"><b>email:</b> <a href="mailto:tahoangbinh.1997@gmail.com">tahoangbinh.1997@gmail.com</a></div>
                        </div>
                        <div class="col-md-7 col-md-text-right">
                            @if(!Auth::guard('web')->check())
                            <div class="entry"><a class="open-popup" data-rel="1"><b>login</b></a>&nbsp; or &nbsp;<a class="open-popup" data-rel="2"><b>register</b></a></div>
                            @else
                            <img src="{{asset('storage')}}/{{Auth::guard('web')->user()->user_pic}}" style="position: relative; width: 60px; height: 60px; top: -2px; ">
                            <div class="entry">
                                ...
                                <div class="cart-toggle hidden-xs hidden-sm">
                                    <div class="cart-overflow">
                                        <div class="cart-entry clearfix">
                                            <a class="cart-entry-thumbnail" href="#"><img src="{{asset('')}}shop_assets/img/product-1.png" alt="" /></a>
                                        ...
                                        <div class="cart-entry clearfix">
                                            <a class="cart-entry-thumbnail" href="#"><img src="{{asset('')}}shop_assets/img/product-2.png" alt="" /></a>
                                            <div class="cart-entry-description">
                                                <table>
                                                    <tr>
                                                        <td>
                                        ...
                                        <div class="cart-entry clearfix">
                                            <a class="cart-entry-thumbnail" href="#"><img src="{{asset('')}}shop_assets/img/product-3.png" alt="" /></a>
                                            <div class="cart-entry-description">
                                                <table>
                                                    <tr>
                                                        <td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <a class="button size-2 style-3" href="{{route('shop.product.cart')}}">
                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-xs-3 col-sm-1">
                            <a id="logo" href="index1.html"><img src="{{asset('')}}shop_assets/img/logo-2.png" alt="" /></a>  
                        </div>
                                                                    ...
                                                                    <div class="swiper-container" data-loop="1">
                                                                        ...
                                                                        <div class="swiper-wrapper">
                                                                            <div class="swiper-slide">
                                                                                <img src="{{asset('')}}shop_assets/img/product-59.jpg" alt="" />
                                                                            </div>
                                                                            <div class="swiper-slide">
                                                                                <img src="{{asset('')}}shop_assets/img/product-61.jpg" alt="" />
                                                                            </div>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                            ...
                                                            <div class="product-shortcode style-5">
                                                                ...
                                                                <div class="preview">
                                                                    <div class="swiper-container" data-loop="1">
                                                                        ...
                                                                        <div class="swiper-wrapper">
                                                                            <div class="swiper-slide">
                                                                                <img src="{{asset('')}}shop_assets/img/product-60.jpg" alt="" />
                                                                            </div>
                                                                            <div class="swiper-slide">
                                                                                <img src="{{asset('')}}shop_assets/img/product-61.jpg" alt="" />
                                                                            </div>
                                            ...
                                            <div class="megamenu">
                                                ...
                                                <div class="content">
                                                    <div class="row nopadding">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="banner-shortcode style-3 rounded-image text-center" style="background-image: url({{asset('')}}shop_assets/img/background-11.jpg);">
                ...
                <div class="footer-top">
                    <div class="row">
                        <div class="col-sm-6 col-md-3 col-xs-b30 col-md-b0">
                            <img src="{{asset('')}}shop_assets/img/logo-1.png" alt="" />
                        ...
                        <div class="col-sm-6 col-md-3 col-xs-b30 col-sm-b0">
                            ...
                            <div class="footer-post-preview clearfix">
                                <a class="image" href="#"><img src="{{asset('')}}shop_assets/img/thumbnail-1.jpg" alt="" /></a>
                                <div class="description">
                            ...
                            <div class="footer-post-preview clearfix">
                                <a class="image" href="#"><img src="{{asset('')}}shop_assets/img/thumbnail-2.jpg" alt="" /></a>
                                <div class="description">
                                    <div class="date">apr 07 / 15</div>
                                    <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                                </div>
                            ...
                            <div class="footer-post-preview clearfix">
                                <a class="image" href="#"><img src="{{asset('')}}shop_assets/img/thumbnail-3.jpg" alt="" /></a>
                                <div class="description">
                                    <div class="date">apr 07 / 15</div>
                                    <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-xs-text-center col-lg-text-right">
                            <div class="footer-payment-icons">
                                <a class="entry"><img src="{{asset('')}}shop_assets/img/thumbnail-4.jpg" alt="" /></a>
                                <a class="entry"><img src="{{asset('')}}shop_assets/img/thumbnail-5.jpg" alt="" /></a>
                                <a class="entry"><img src="{{asset('')}}shop_assets/img/thumbnail-6.jpg" alt="" /></a>
                                <a class="entry"><img src="{{asset('')}}shop_assets/img/thumbnail-7.jpg" alt="" /></a>
                                <a class="entry"><img src="{{asset('')}}shop_assets/img/thumbnail-8.jpg" alt="" /></a>
                                <a class="entry"><img src="{{asset('')}}shop_assets/img/thumbnail-9.jpg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="popup-container size-1">
                <div class="popup-align">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <input class="simple-input" type="text" name="email" value="" placeholder="Your Email or Username" />
                        @if($errors->has('email')) 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <button class="button size-2 style-3" style="border: 0px; ">
                                    <span class="button-wrapper">
                                        <span class="icon"><img src="{{asset('')}}shop_assets/img/icon-4.png" alt="" /></span>
                                        <span class="text">submit</span>
                                    </span>
            ...
            <div class="popup-container size-1">
                <div class="popup-align">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        @endif
                        <div class="empty-space col-xs-b10 col-sm-b20"></div>
                        <input class="simple-input" type="text" name="username" value="" placeholder="Your username" />
                        ...
                        @endif
                        <div class="empty-space col-xs-b10 col-sm-b20"></div>
                        <input class="simple-input" type="password" name="password_confirmation" value="" placeholder="Repeat password" />
                        <div class="empty-space col-xs-b10 col-sm-b20"></div>
                        <div class="row">
                            ...
                            <div class="col-sm-5 text-right">
                                <button class="button size-2 style-3" href="#" style="border: 0px; ">
                                    <span class="button-wrapper">
                                        <span class="icon"><img src="{{asset('')}}shop_assets/img/icon-4.png" alt="" /></span>
                                        <span class="text">submit</span>
                                    </span>
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-4.jpg"></div>
                                       </div>
                                       <div class="swiper-slide">
                                            <div class="swiper-lazy-preloader"></div>
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-5.jpg"></div>
                                       </div>
                                       <div class="swiper-slide">
                                            <div class="swiper-lazy-preloader"></div>
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-6.jpg"></div>
                                       </div>
                                       <div class="swiper-slide">
                                            <div class="swiper-lazy-preloader"></div>
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-7.jpg"></div>
                                       </div>
                                       <div class="swiper-slide">
                                            <div class="swiper-lazy-preloader"></div>
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-8.jpg"></div>
                                       </div>
                                       <div class="swiper-slide">
                                            <div class="swiper-lazy-preloader"></div>
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-9.jpg"></div>
                                       </div>
                                       <div class="swiper-slide">
                                            <div class="swiper-lazy-preloader"></div>
                                            <div class="product-big-preview-entry swiper-lazy" data-background="{{asset('')}}shop_assets/img/product-preview-10.jpg"></div>
                                       </div>
                                   </div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-4_.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-5_.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-6_.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-7_.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-8_.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-9_.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="{{asset('')}}shop_assets/img/product-preview-10_.jpg" alt="" />
                                            </div>
                                       </div>
    ...
    <script src="{{asset('')}}shop_assets/js/jquery-2.2.4.min.js"></script>
    <script src="{{asset('')}}shop_assets/js/swiper.jquery.min.js"></script>
    <script src="{{asset('')}}shop_assets/js/global.js"></script>

    <!-- styled select -->
    <script src="{{asset('')}}shop_assets/js/jquery.sumoselect.min.js"></script>

    <!-- counter -->
    <script src="{{asset('')}}shop_assets/js/jquery.classycountdown.js"></script>
    <script src="{{asset('')}}shop_assets/js/jquery.knob.js"></script>
    <script src="{{asset('')}}shop_assets/js/jquery.throttle.js"></script>

    <!-- range slider -->
    <script src="{{asset('')}}shop_assets/js/jquery-ui.min.js"></script>
    <script src="{{asset('')}}shop_assets/js/jquery.ui.touch-punch.min.js"></script>
    @yield('footer')
    <script>
