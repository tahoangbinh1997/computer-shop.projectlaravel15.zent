...
<html lang="en">
    <head>        
        ...
        <link rel="stylesheet" type="text/css" id="theme" href="{{asset('')}}admin_assets/css/theme-blue.css"/>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <!-- START X-NAVIGATION -->
                <ul class="x-navigation" style="height: 666px!important;">
                    <li class="xn-logo">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="{{asset('storage')}}/{{ Auth::guard('admin')->user()->admin_pic }}" alt="{{ Auth::guard('admin')->user()->name }}"/>
                        </a>
                        <div class="profile">
                    ...
                    <li class="@yield('users') xn-openable">
                        <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Quản Lý Người Dùng</span></a>
                        <ul>
                            <li class="@yield('users-active')"><a href="{{route('admin.user.active.managers')}}">Người dùng đã kích hoạt</a></li>
                            <li class="@yield('users-deactive')"><a href="{{route('admin.user.deactive.managers')}}">Người dùng hủy kích hoạt</a></li>
                            <li class="@yield('users-delete')"><a href="{{route('admin.user.delete.managers')}}">Người dùng đã bị xóa</a></li>
                        </ul>
                    </li>
                    @if(Auth::guard('admin')->user()->permission == 0)
                    <li class="@yield('admins') xn-openable">
                        <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Quản Lý Nhân Viên</span></a>
                        <ul>
                            <li class="@yield('admins-active')"><a href="{{route('admin.admins.active.managers')}}">Nhân viên đã kích hoạt</a></li>
                            <li class="@yield('admins-deactive')"><a href="{{route('admin.admins.deactive.managers')}}">Nhân viên hủy kích hoạt</a></li>
                            <li class="@yield('admins-delete')"><a href="{{route('admin.admins.delete.managers')}}">Nhân viên đã bị xóa</a></li>
                        </ul>
                    </li>
                    @endif

                    <li class="@yield('products') xn-openable">
                        <a href="#"><span class="glyphicon glyphicon-shopping-cart"></span> <span class="xn-text">Quản Lý Sản Phẩm</span></a>
                        <ul>
                            <li class="@yield('products-instock')"><a href="{{route('admin.product.instock.managers')}}">Sản phẩm còn trong kho</a></li>
                            @if(Auth::guard('admin')->user()->permission == 0 || Auth::guard('admin')->user()->permission == 2)
                            <li class="@yield('products-outstock')"><a href="{{route('admin.product.outstock.managers')}}">Sản phẩm đã hết hàng</a></li>
                            @endif
                        </ul>
                    </li>
                </ul>
        ...
        <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="{{ route('admin.logout') }}" class="btn btn-success btn-lg"
